...
// 模块级单例存储配置
const wsUrl = useLocalStorage('wheeltec:wsUrl', 'ws://100.122.158.62:9090');
const videoUrl = useLocalStorage('wheeltec:videoUrl', 'http://100.122.158.62:8080/stream?topic=/image_raw');
// 模块级单例状态
